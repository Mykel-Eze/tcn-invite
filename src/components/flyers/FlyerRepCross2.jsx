    ...
    return (
        <div ref={ref} className="w-[300px] h-[500px] bg-[#1a0510] relative flex flex-col shadow-2xl overflow-hidden font-sans text-white">
            ...
            <div className="absolute inset-0">
                ...
                <div className="absolute inset-0 bg-gradient-to-t from-[#12040b] via-[#12040b]/10 to-transparent" />
            </div>
            ...
            <div className="pt-4 w-full flex flex-col items-center justify-center relative">
