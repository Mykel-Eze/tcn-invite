    ...
    return (
        <div ref={ref} className="w-[300px] h-[500px] bg-[#12040b] text-white relative flex flex-col shadow-2xl overflow-hidden font-sans">
            ...
            <div className="px-5 pt-5 pb-2 flex justify-between items-center z-10 shrink-0">
                <img src={churchLogo} alt="TCN" className="h-8 w-auto opacity-90" />
            ...
            <div className="px-5 py-2 flex flex-col items-center z-10 shrink-0">
                <p className="text-[9px] uppercase tracking-[0.2em] font-bold text-[#fff] mt-2 mb-[-10px] text-center">
                    You are specially invited to
                </p>

                <img src={eventTitleImage} alt="KindRED Connect" className="w-[150px] object-contain drop-shadow-[0_0_10px_rgba(255,255,255,0.2)]" />

                {/* Pastor Circle */}
                <div className="relative w-24 h-24 rounded-full border-2 border-[#BF3978] p-1 shadow-[0_0_20px_rgba(166,41,87,0.4)] mt-[-12px]">
                    {/* Ministering Badge */}
                    <div className="absolute -top-3 inset-x-0 flex justify-center z-20">
                        <span className="bg-[#12040b] text-white text-[7px] font-bold uppercase py-0.5 px-2 rounded-full border border-[#D9644A]/50 shadow-md tracking-wider">
                            Ministering
                        </span>
                    </div>
            ...
            <div className="flex-1 px-4 pb-4 flex flex-col justify-end z-10 min-h-0">
                ...
                <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-xl p-3 flex flex-col relative">
                    ...
                    <div className="text-center border-b border-white/10 pb-2 mb-2">
                        <p className="text-[9px] text-gray-400 font-medium mb-0.5">Join us this Sunday, Feb 15</p>
                        ...
                        <div className="flex-1 space-y-2 min-w-0">
                            ...
                            <div className="flex items-start gap-2">
                                ...
                                <div className="min-w-0">
                                    ...
                                    <p className="text-[9px] text-gray-400 leading-tight">{campus?.address}</p>
                                </div>
                            </div>
